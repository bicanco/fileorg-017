...
char **leCSV(FILE *arquivo){
	...
	int i; // variavel de interaÃ§Ã£o de laÃ§o

	// alocando memÃ³ria para guardar ponteiros para todos as strings com valores dos campos
	...
	for (i = 0; i < NUM_CAMPOS; i++){ // leia os 8 campos de um registro
		...
		do {
			...
			// cheque se Ã© um caractere acentuado e deve ser convertido
