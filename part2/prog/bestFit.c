...
/**
 	insereLista_Ascendente

 	Função que insere o registro removido em uma lista ascendente
...
/**
 	removeRegistro_BestFit

 	Função que remove um registro de um arquivo que utiliza o método de Best-Fit
	PARAMETRO -arquivo- | o arquivo do qual se quer remover o registro
...
/**
 	insereRegistro_BestFit

	Função que insere de maneira dinâmica um novo registro em um arquivo de dados segundo o mátodo Best-Fit
